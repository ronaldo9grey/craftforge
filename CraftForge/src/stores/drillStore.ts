...
const PARAM_TO_STEP_KEYWORDS: Record<string, string[]> = {
  ...
  // 海上钻井平台场景（rpm/torque/temp/pressure/vibration 已在 TBM 段定义，此处仅补充 offshore 专属参数）
  hoist_load:    ['大钩载荷', '钻具', '活动钻具'],
  wob:           ['钻压', '降低钻压'],
  hoist_speed:   ['提升速度', '提拉'],
  flow_rate:     ['泥浆泵流量', '泥浆', '流量', '排量', '循环'],
  stroke:         ['冲次', '泥浆泵'],
  annular_pressure: ['环空压力', '环空', '背压', '节流'],
  ram_status:     ['闸板密封', 'BOP', '防喷器'],
  control_pressure: ['控制液压', '液压'],
  derrick_load:  ['井架载荷', '井架'],
  wind_speed:     ['风载', '风速', '风'],
  tension:        ['张力', '隔水管'],
  mud_return:     ['泥浆返出', '返出', '泥浆'],
  angle:          ['偏角', '隔水管'],
  cement_pressure: ['固井泵压', '固井'],
  cement_flow:    ['固井流量', '固井'],
  choke_pressure: ['节流压力', '节流', '关节流'],
  kill_flow:      ['压井流量', '压井'],
  valve_pos:      ['节流阀开度', '节流阀'],
  throughput:     ['处理量', '振动筛'],
  mesh_status:    ['筛网完好度', '筛网'],
  flare_rate:     ['燃烧量', '火炬'],
  flare_temp:     ['火焰温度', '火炬'],
  power:          ['输出功率', '发电机'],
  voltage:        ['电压', '发电机'],
  frequency:      ['频率', '发电机'],
  wind_deck:      ['甲板风速', '甲板', '风速'],
  visibility:     ['能见度', '直升机'],
};
