...
export const aluminumCouplings: CouplingRule[] = [
  ...
  // P. 母线电流 → 母线温度（焦耳热）— 母线参数现在合并到 CELL-101 的 bus_temp
  { from: { equipmentId: 'TRA-301', param: 'bus_current' }, to: { equipmentId: 'CELL-101', param: 'bus_temp' }, gain: 0.06, baseline: 480, tau: 30 },
  // 二次电压 → 各槽母线电压（直接传递）
  { from: { equipmentId: 'TRA-301', param: 'secondary_dc_volt' }, to: { equipmentId: 'CELL-101', param: 'bus_voltage' }, gain: 1.0, baseline: 1660, tau: 1 },
  { from: { equipmentId: 'TRA-301', param: 'secondary_dc_volt' }, to: { equipmentId: 'CELL-102', param: 'bus_voltage' }, gain: 1.0, baseline: 1660, tau: 1 },
  ...
  // N. 真空泵压力 → 抬包真空度（直接传递，真空泵已合并入 POT-202）
  { from: { equipmentId: 'POT-202', param: 'vacuum_pump_p' }, to: { equipmentId: 'POT-202', param: 'vacuum_pressure' }, gain: 0.9, baseline: -88, tau: 2 },
